...
public:
    ...
    QPushButton *pushButtonKlient;
    QPushButton *pushButtonSerwer;
    QWidget *widget1;
    QWidget *widget3;
    QWidget *widget2;
...
""));
        ...
        pushButtonKlient = new QPushButton(groupBox_8);
        pushButtonKlient->setObjectName("pushButtonKlient");

        horizontalLayout_3->addWidget(pushButtonKlient);

        pushButtonSerwer = new QPushButton(groupBox_8);
        pushButtonSerwer->setObjectName("pushButtonSerwer");

        horizontalLayout_3->addWidget(pushButtonSerwer);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonKlient->setText(QCoreApplication::translate("MainWindow", "Klient", nullptr));
        pushButtonSerwer->setText(QCoreApplication::translate("MainWindow", "Serwer", nullptr));
